...
namespace Stocki.Discord.Module;

public class OverviewModule : InteractionModuleBase<SocketInteractionContext>
{
    private readonly ILogger<OverviewModule> _logger;
    private readonly IMediator _mediator;

    public OverviewModule(ILogger<OverviewModule> logger, IMediator m)
    {
        _logger = logger;
        _mediator = m;
    }
